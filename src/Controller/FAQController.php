...
class FAQController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le duo question/réponse a bien été ajouté !');
    ...
    public function edit(Request $request, FAQ $fAQ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le duo question/réponse a bien été modifié !');
    ...
    public function delete(Request $request, FAQ $fAQ): Response
    {
        if ($this->isCsrfTokenValid('delete'.$fAQ->getId(), $request->request->get('_token'))) {
            ...
            $this->addFlash('success', 'Le duo question/réponse a bien été supprimé !');
        } else {
